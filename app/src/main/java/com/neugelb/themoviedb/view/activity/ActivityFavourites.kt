...
class ActivityFavourites : ActivityBase() {
    ...
    @field:[Inject]
    lateinit var factory: ViewModelFactory<ViewModelFavourites>
    private val viewModel: ViewModelFavourites by viewModels { factory }
    ...
    override fun create(savedInstanceState: Bundle?) {
        ...
        viewModel.allObservable.observe(this) {
            when (it.getStatus()) {
